...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Part 1
        System.out.println("Computing teaching cost");
        ...
        // Teacher now has 4 activities so trigger will stop it from adding more
        ...
        System.out.println("Displaying exercise allocation");
        service.displayExerciseAllocation(id);
